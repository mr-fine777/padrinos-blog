...
<div class="window">
  <div class="content">
    <h1 id="how-to-access">How to access the Tor Browser or Dark Web</h1>
      <p>So you want to start using the Tor browser? Access the dark web and be all cool? Well this is a very simple tutorial on how to access the Tor browser. It's really quite simple.
<br><br>
...
<div class="comment-window">
  ...
  <div class="comments-display">
    <?php include 'load_comments.php'; echo loadComments('how-to-access'); ?>
    <form action="save_comment.php" method="POST" onsubmit="return submitComment(event, 'how-to-access')">
      <input type="hidden" name="article_id" value="how-to-access">
      <p>Name: <input type="text" name="username" maxlength="16" required></p>
      <p>Comment: <textarea name="comment" maxlength="256" required></textarea></p>
      <input type="hidden" name="g-recaptcha-response" id="g-recaptcha-response-how-to-access">
...
<script type="text/javascript">
	atOptions = {
		'key' : 'fd93c7f18593a66f1d75289e1ef61a95',
		'format' : 'iframe',
		'height' : 90,
		'width' : 728,
		'params' : {}
...
<script type="text/javascript" src="//www.highperformanceformat.com/fd93c7f18593a66f1d75289e1ef61a95/invoke.js"></script>
</div>

<div class="window">
  <div class="content">
    <h1 id="victim-story">I became a victim on the Dark Web at 13…</h1>
      <p>At the age of 13, I became a victim on the Dark Web.
A curious young mind, full of naivety and innocence, I downloaded the Tor Browser at my friend's request — unaware of the dangers that lay ahead. I didn't really know where to look for anything, so after a couple of Google searches, I stumbled upon something called The Hidden Wiki. While I now know it's a mostly useless link directory, back then I didn't.
<br><br>
...
<br><br>
Then a user joined the chat — he went by the name "CJ."
We started talking more frequently, eventually moving to private messages. One day, he sent me a link. I was completely naive and stupid. I didn't think twice. Whatever information he may have pulled from that link was probably useless to him, but that didn't matter. What mattered was that I clicked on it.
<br><br>
...
Do not engage with random strangers on the Dark Web.
If you must use it, only stick to verified onion mirrors and directories like:
<br><br>
onion.live
<br><br>
    dark.fail
<br><br>
    tor.taxi
<br><br>
Don't explore random chatrooms, imageboards, or "Omegle-style" websites.
I don't necessarily think of myself as a victim — but I promise you: if you wander into the wrong places, you will see things you never wanted to see. It doesn't matter if you're young or old. People are victimized on the Dark Web every single day in different ways.
<br><br>
I beg you: take PERSEC (Personal Security) and OPSEC (Operational Security) seriously.
You could easily be doxxed from the smallest piece of information, which can lead to serious consequences — SIM swapping, SWATtings, DDoS attacks, extortion, ransomware, malware, worms, RATs (Remote Access Trojans), and more.
<br><br>
...
<br><br>
If you guys want to hear more of my interactions on the Dark Web, please let me know. Or if you want to hear more about Cyber Security, let me know as well.</p>
  </div>
  <div class="overlay"></div>
</div>
<div class="comment-window">
  <h1>Comments</h1>
  <div class="comments-display">
    <?php include 'load_comments.php'; echo loadComments('victim-story'); ?>
    <form action="save_comment.php" method="POST" onsubmit="return submitComment(event, 'victim-story')">
      <input type="hidden" name="article_id" value="victim-story">
      <p>Name: <input type="text" name="username" maxlength="16" required></p>
      <p>Comment: <textarea name="comment" maxlength="256" required></textarea></p>
      <input type="hidden" name="g-recaptcha-response" id="g-recaptcha-response-victim-story">
      <input type="submit" value="Post">
    </form>
  </div>
</div>
...
<div class="window">
  <div class="content">
    <h1 id="tiktok-ban">How to prepare if TikTok is banned again.</h1>
      <p>On January 18, 2025, TikTok was banned for a whole 12 hours. It left a permanent scare on the American people, people began acting erratically and losing their minds, one man in Wisconsin even set a congressman's office on fire, who is now looking at more than 50 years in prison. So how do you prevent burning down a building because of TikTok being inevitably banned again?
<br><br>
...
<div class="comment-window">
  <h1>Comments</h1>
  <div class="comments-display">
    <?php include 'load_comments.php'; echo loadComments('tiktok-ban'); ?>
    <form action="save_comment.php" method="POST" onsubmit="return submitComment(event, 'tiktok-ban')">
      <input type="hidden" name="article_id" value="tiktok-ban">
      <p>Name: <input type="text" name="username" maxlength="16" required></p>
      <p>Comment: <textarea name="comment" maxlength="256" required></textarea></p>
      <input type="hidden" name="g-recaptcha-response" id="g-recaptcha-response-tiktok-ban">
      <input type="submit" value="Post">
    </form>
  </div>
</div>
...
<div class="comment-window">
  <h1>Comments</h1>
  <div class="comments-display">
    <?php include 'load_comments.php'; echo loadComments('scam-story'); ?>
    <form action="save_comment.php" method="POST" onsubmit="return submitComment(event, 'scam-story')">
      <input type="hidden" name="article_id" value="scam-story">
      <p>Name: <input type="text" name="username" maxlength="16" required></p>
      <p>Comment: <textarea name="comment" maxlength="256" required></textarea></p>
      <input type="hidden" name="g-recaptcha-response" id="g-recaptcha-response-scam-story">
      <input type="submit" value="Post">
    </form>
  </div>
</div>
...
<div class="window">
  <div class="content">
    <h1 id="dark-web-markets">Dark web markets and their possible downfalls</h1>
      <p>Back in 2013, Ross William Ulbricht was inside the San Francisco Public Library when he was cornered by the FBI. They arrested him, seized his laptop, and shut down his dark web website, "The Silk Road," which had garnered him over one billion dollars but ultimately cost him his freedom. Following his arrest, new markets emerged and disappeared, creating a domino effect with more and more marketplaces opening and closing, often ending in similar outcomes.
<br><br>
...
<br><br>
Despite this, my friends still pester me about starting a dark web marketplace. Though it might seem like an attractive idea, I know that starting one is a death sentence, throwing away all the money made, the time spent on creating and marketing such a site, as well as risking my friends' and my own life.</p>
  </div>
  <div class="overlay"></div>
</div>
<div class="comment-window">
  <h1>Comments</h1>
  <div class="comments-display">
    <?php include 'load_comments.php'; echo loadComments('dark-web-markets'); ?>
    <form action="save_comment.php" method="POST" onsubmit="return submitComment(event, 'dark-web-markets')">
      <input type="hidden" name="article_id" value="dark-web-markets">
      <p>Name: <input type="text" name="username" maxlength="16" required></p>
      <p>Comment: <textarea name="comment" maxlength="256" required></textarea></p>
      <input type="hidden" name="g-recaptcha-response" id="g-recaptcha-response-dark-web-markets">
      <input type="submit" value="Post">
    </form>
  </div>
</div>
...
<br><br>
Overall, many users prefer Monero for its enhanced security, making it their cryptocurrency of choice.</p>
  </div>
  <div class="overlay"></div>
</div>
<div class="comment-window">
  <h1>Comments</h1>
  <div class="comments-display">
    <?php include 'load_comments.php'; echo loadComments('monero-bitcoin'); ?>
    <form action="save_comment.php" method="POST" onsubmit="return submitComment(event, 'monero-bitcoin')">
      <input type="hidden" name="article_id" value="monero-bitcoin">
      <p>Name: <input type="text" name="username" maxlength="16" required></p>
      <p>Comment: <textarea name="comment" maxlength="256" required></textarea></p>
      <input type="hidden" name="g-recaptcha-response" id="g-recaptcha-response-monero-bitcoin">
      <input type="submit" value="Post">
    </form>
  </div>
</div>
...
<br><br>
    In the windows search bar, type in the word "regedit" and press enter.
    Paste the following at the top of the bar under "File"
<br><br>
...
<br><br>
    Disconnect from the internet. They cannot have access to the computer if the computer has no internet.
    Use your phone or some other device to change important passwords
    Connect your phone or some form of storage device to your Computer
    Transfer important photos and videos to the storage device
    If you have a restore point set up, proceed to system restore to that point
    If you do not, you will have to factory reset your PC. If you do not have access to any forms of storage device, put the important files inside of a zip file
    Connect to the internet and quickly upload them to some form of cloud, then disconnect and factory reset your computer
<br><br>
...
<div class="comment-window">
  <h1>Comments</h1>
  <div class="comments-display">
    <?php include 'load_comments.php'; echo loadComments('malware'); ?>
    <form action="save_comment.php" method="POST" onsubmit="return submitComment(event, 'malware')">
      <input type="hidden" name="article_id" value="malware">
      <p>Name: <input type="text" name="username" maxlength="16" required></p>
      <p>Comment: <textarea name="comment" maxlength="256" required></textarea></p>
      <input type="hidden" name="g-recaptcha-response" id="g-recaptcha-response-malware">
      <input type="submit" value="Post">
    </form>
  </div>
</div>
...
<div class="comment-window">
  <h1>Comments</h1>
  <div class="comments-display">
    <?php include 'load_comments.php'; echo loadComments('red-room'); ?>
    <form action="save_comment.php" method="POST" onsubmit="return submitComment(event, 'red-room')">
      <input type="hidden" name="article_id" value="red-room">
      <p>Name: <input type="text" name="username" maxlength="16" required></p>
      <p>Comment: <textarea name="comment" maxlength="256" required></textarea></p>
      <input type="hidden" name="g-recaptcha-response" id="g-recaptcha-response-red-room">
      <input type="submit" value="Post">
    </form>
  </div>
</div>
...
<div class="window">
  <div class="content">
    <h1 id="dark-web-regret">I went on the dark web and instantly regret everything</h1>
      <p>See this, this is exactly what anyone and everyone would say if they knew absolutely nothing about anything involving Tor. The dark web isn't the worst thing on earth, there's people drugging and harvesting organs on the street and visiting some websites just freaks people out. I promise you, it's not that bad. I will go over some very simple things to do in case you want to go on Tor, the dark web, The Mariana's Web and more.
<br><br>
Security
<br><br>
There's some pretty simple guidelines before you use Tor. Number 1 is using a VPN. I use ProtonVPN because of the anonymity, the zero data collection policies, their free emailing service and more. You can sign up to ProtonVPN for free here: https://protonvpn.com/pricing
<br><br>
Downloading The Tor Browser
<br><br>
Downloading Tor is very easy, just go to https://torproject.org and download your version of Tor then begin the installation process.
<br><br>
Tor Security
<br><br>
Now, before you connect to Tor, press the three lines under the x button in the corner, and select settings. Click on the search bar and type in "bridges". Under the "Add a New Bridge" section, press "Select a Built-In Bridge…" Then from there you want to choose "obfs4 (Built-In) and Connect. Now you will be connected to Tor. Once Tor has established a Connection, go to this website: https://addons.mozilla.org/en-US/firefox/addon/user-agent-string-switcher/
<br><br>
This is an OS/Browser spoofer. This is to prevent hackers from finding out which browser or operating software you're using. I recommend using the opposite of what you're actually using. For example, if you use a Windows device, I suggest setting your settings to "Safari" and "MacOS" however, if you're using a Mac, then you should set your settings to "Chrome" and "Windows"
<br><br>
With these 3 security measures, you will be a lot safer online than if you would be just normally searching through the dark web. However, if you feel as if this may be not enough, I also have an OPSEC/PERSEC tutorial on my page so you can check that out if you'd like a little more protection while browsing.
<br><br>
Another thing to remember is pretty obvious things, don't go out of your way to tell others information about yourself, your family, your friends, anyone you know in real life or online. These are all direct connections to you, then again, as long as you're not visiting any IRC chatroom, you'll be fine.
<br><br>
Using Tor services
<br><br>
A lot of people have spoken time and time again about The Hidden Wiki, which every time, they have been wrong. If you genuinely want to use any hidden, tor, or dark web service, don't use The Hidden Wiki. Instead, use a verified Onion directory for your adventures.
<br><br>
    dark.fail https://dark.fail/
    tor.taxi https://tor.taxi/
    ONION.live https://onion.live/
<br><br>
These are the main, and probably the most used tor directories, when you use these you have guaranteed access to the dark web, instead of the commonly mistaken Hidden wiki, which is a honeypot/scam service set up to make some money from wannabe/soontobe cyber criminals.
<br><br>
Other things to note
<br><br>
Some things to note is that there's no hitman for hire, hacker for hire, ddoser for hire, or anything similar because it's all scam. No red rooms because those are scams, there's nothing of the sort. It's all fake. It's always been fake. There's no organs to buy, no blood gold or diamonds, no weapons to buy, nothing. You can buy drugs, fraudulent items, and stolen accounts. That's honestly it. You can buy other things, but I'm not going to link them here because 1. I don't know where you'd find stuff like that, and 2. it's fucking disgusting. Anyways, hope you all have fun, please stay safe, but in all honesty, you're not likely to be harmed.</p>
  </div>
  <div class="overlay"></div>
</div>
<div class="comment-window">
  <h1>Comments</h1>
  <div class="comments-display">
    <?php include 'load_comments.php'; echo loadComments('dark-web-regret'); ?>
    <form action="save_comment.php" method="POST" onsubmit="return submitComment(event, 'dark-web-regret')">
      <input type="hidden" name="article_id" value="dark-web-regret">
      <p>Name: <input type="text" name="username" maxlength="16" required></p>
      <p>Comment: <textarea name="comment" maxlength="256" required></textarea></p>
      <input type="hidden" name="g-recaptcha-response" id="g-recaptcha-response-dark-web-regret">
      <input type="submit" value="Post">
    </form>
  </div>
</div>
...
<div class="window">
  <div class="content">
    <h1 id="opsec-persec">OPSEC and PERSEC, How to stay anonymous online</h1>
      <p>OPSEC (Operations Security) and PERSEC (Personal Security) are both important factors depending on what you plan to be using them for. Today I will discuss some basic things to use for your personal life, as well as in certain scenarios.
<br><br>
PERSEC
<br><br>
...
<br><br>
DNS (Domain Name System) is another piece of data that's shared while you're online. Changing your DNS is again, really easy. I use DNSJumper (https://www.sordum.org/downloads/?dns-jumper) which has been really easy to use. First click "Flush DNS" then choose the DNS server option you'd like to use. I usually use the OpenDNS servers,
<br><br>
...
<br><br>
Again, I don't recommend you do this for your personal phone literally at all. In fact it'd help if you buy an older phone instead of using the one linked to your service provider and in case you fuck up don't lose your phone and waste your money paying for your phone service.</p>
  </div>
  <div class="overlay"></div>
</div>
<div class="comment-window">
  <h1>Comments</h1>
  <div class="comments-display">
    <?php include 'load_comments.php'; echo loadComments('opsec-persec'); ?>
    <form action="save_comment.php" method="POST" onsubmit="return submitComment(event, 'opsec-persec')">
      <input type="hidden" name="article_id" value="opsec-persec">
      <p>Name: <input type="text" name="username" maxlength="16" required></p>
      <p>Comment: <textarea name="comment" maxlength="256" required></textarea></p>
      <input type="hidden" name="g-recaptcha-response" id="g-recaptcha-response-opsec-persec">
      <input type="submit" value="Post">
    </form>
  </div>
</div>
...
<div class="window">
  <div class="content">
    <h1 id="search-engines">Searching the dark web with search engines.</h1>
      <p>I saw an article on Medium talking about searching through tor or the dark web or whatever to find super scary hacker websites. Hitman for hire! Red rooms! Hacker for hire! Why wouldn't you just use an actually verified source is beyond me, but regardless of all of that, why would an actual cyber criminal work for some loser nobody who's paying him $50 through bitcoin, when he could just as easily take your money and walk? The real way to search through the dark web is less strange. Information about link directories here: https://medium.com/@misterfine777/link-directories-for-verified-tor-links-5a1e1d4e3192
<br><br>
SEARCH ENGINES
<br><br>
If for some reason you don't want to actually use verified and trusted sources, you can use a verified tor search engine, nothing like torch or whatever the other one was. Instead you can use some real tor search engines. How they search through the data is usually by looking for keywords in the SEO data, or through the actual website itself.
<br><br>
Dig — http://digdig2nugjpszzmqe5ep2bk7lqfpdlyrkojsx2j6kzalnrqtwedr3id.onion/
<br><br>
Here we go, real deal search engine. Regardless of if it mainly finds honeypots or scams is irrelevant. The main thing to remember is that it isn't going to rob you of your credentials or your computers resources. Dig, along with the others I'm going to list are actually verified search engines. Verified by sources such as https://tor.taxi/ and https://dark.fail/ more on that later.
<br><br>
Recon — http://recon222tttn4ob7ujdhbn3s4gjre7netvzybuvbq2bcqwltkiqinhad.onion/
<br><br>
Recon is a legend. Recon has always been known for being one of the best, and one of the first in this. Regardless if you really want to use a search engine for searching the dark web. Use this.
<br><br>
Vormweb — http://volkancfgpi4c7ghph6id2t7vcntenuly66qjt6oedwtjmyj4tkk5oqd.onion/
<br><br>
Vormweb is another tor search engine for finding super spooky things on the dark web. I don't know that much about it, but I do know that along with the others, you can use it to search for clearnet sites as well. Dig is different, but Recon and vormweb you can use to replace your day to day search engine. No need for duckduckgo.
<br><br>
Link directories
<br><br>
Now I'm going to teach you all about a term I've already covered before. Link directories are websites which include verified sources for websites regarding the subject of the website. These are specifically for the dark web. I've covered this subject already in one of my previous articles, so if you want to read it you can just go here: https://medium.com/@misterfine777/link-directories-for-verified-tor-links-5a1e1d4e3192
<br><br>
But if you don't care that much, some common but very useful link directories are
<br><br>
dark.fail
<br><br>
onion.live
...
tor.taxi
<br><br>
I also cover some other ones in there as well, such as why you should never use something such as https://thehiddenwiki.org/ (spoiler: it's a honeypot website used to catch wannabe/soontobe cyber criminals, as well as take their money)
<br><br>
Over all, I understand that the dark web or tor can be scary and hard to understand. But do not worry. You can always count on me to help you!</p>
  </div>
  <div class="overlay"></div>
</div>
<div class="comment-window">
  <h1>Comments</h1>
  <div class="comments-display">
    <?php include 'load_comments.php'; echo loadComments('search-engines'); ?>
    <form action="save_comment.php" method="POST" onsubmit="return submitComment(event, 'search-engines')">
      <input type="hidden" name="article_id" value="search-engines">
      <p>Name: <input type="text" name="username" maxlength="16" required></p>
      <p>Comment: <textarea name="comment" maxlength="256" required></textarea></p>
      <input type="hidden" name="g-recaptcha-response" id="g-recaptcha-response-search-engines">
      <input type="submit" value="Post">
    </form>
  </div>
</div>
...
<div class="window">
  <div class="content">
    <h1 id="chatrooms">What are the common darkweb chatrooms and forums?</h1>
      <p>Chatrooms, forums and Chans are all very commonplace for the Tor browser. Many of which contain a lot of very bad things. Things that you should not be interested in at all. Considering this transparency with my viewers, I'm going to show these chatrooms, forums and Chans that you can visit. Be warned I am not responsible for any of the illegal things you do on these websites, nor am I responsible for anything and everything you see. You chose to go here on your own behalf, your own conscious decision to view and use these sites knowing very well what I warned. You may know what a forum is, similar to the ones you go on for your favorite video games, or another example a chatroom, similar to Discord, Telegram or Omegle. But what about a Chan? What is a Chan? Chan is an abbreviation the word "channel" it is most common in image boards like 4chan, 8chan and lainchan. But did you know there's millions of other Chans/image boards that are similar to 4chan and 8chan, however they are a lot more commonplace on the Tor browser. Well what is 4chan? It's an anonymous imageboard site that is used by people usually on the Clearnet, however I'm pretty sure there is an onion version of the site. Now, Let's cover some of the most common chatrooms, forums and Chans/imageboards that you'll come across if you are found in one on the darkweb.
<br><br>
Dread Forums
<br><br>
http://dreadytofatroptsdj6io7l3xptbet6onoyno2yv7jicoxknyazubrad.onion
<br><br>
Dread forums is similar many other forums you may be used to such as Reddit or other forum sites, launched around 2018. It features several darkweb discussions over content such as darkweb markets, news relating to the darkweb and sometimes tutorials or methods explaining how to do certain illegal things such as fraud. It's been trusted with many of the markets on the darkweb, such as Bohemia market, to be one of the hosts containing links to the Bohemia market. My experience on Dread has always been good, so I'd highly recommend the Dread forums to anyone seeking information, needing assistance or just wanting to stay in the loop with darkweb controversies and news.
<br><br>
Libre Forum
<br><br>
http://libreeunomyly6ot7kspglmbd5cvlkogib6rozy43r2glatc6rmwauqd.onion
<br><br>
Libre Forum is mostly similar to Reddit, however it also contains chatrooms usually one or more, launched around 2022, was created as an alternative to something like Dread forums to share their opinions on certain topics, and a more refreshing take on said topics instead of just talking about breaking the law. It's a sort of safe haven for these users. Though I do not know much about Libre I would recommend it to anyone seeking something else besides Dread, and more of a community feeling rather than an news and tip forum.
<br><br>
RuTor
<br><br>
http://rutorzzmfflzllk5.onion/
<br><br>
For my Russian users this website is similar to Dread forums, however it is completely Russian based, if you're seeking something new and based around your heritage this would be for you. I don't know much about it however since I don't speak Russian but you'd probably enjoy it. There is also Cebulka and Deutschland im Deep Web for Polish and German speakers respectively.
<br><br>
For Cebulka: http://cebulka7millweap.onion/
<br><br>
For Deutschland im Deep Web: http://germanyruvvy2tcw.onion/
<br><br>
Ableonion
<br><br>
http://notbumpz34bgbz4yfdigxvd6vzwtxc3zpt5imukgl6bvip2nikdmdaad.onion/
<br><br>
Ableonion is usually full of trolls, however sometimes there's some interesting people who actually want to talk about something. Usually though you'll just find people pretending to be schizophrenic. However they also support one to one (p2p) chat as well as their public chatroom.
<br><br>
Chat with strangers
<br><br>
http://tetatl6umgbmtv27.onion/
<br><br>
I am going to warn you before you go to this website that this website is completely filled to the brim with pedophiles. As stated by ONION.live "you will rarely find normal dudes on here, most of em are pedos" so take it with a warning. Chat with strangers is a very obscure p2p chat platform similar to Omegle but without the video calls. It has been down for 2 years thankfully so you cannot go there. However I'm including it because from here it only gets worse.
<br><br>
8kun
<br><br>
http://jthnx5wyvjvzsxtu.onion/
<br><br>
Very similar to 4chan, 8kun (formerly 8chan) is a Chan website that is going to be a growing trend from here on, completely similar to 4chan, 8kun is just the onion version of 4chan, you'll find a lot more illegal and illicit activity happening on 8kun so be warned.
<br><br>
Endchan
<br><br>
http://enxx3byspwsdo446jujc52ucy2pf5urdbhqw3kbsfhlfjwmbpj5smdad.onion/
<br><br>
Serious warning before going on here. I literally opened the site and the first thing I saw was a cp link. Probably a virus but regardless just don't click on anything here if you don't have any security and to be honest just don't go here. It's called Endchan as a joke to being "the imageboard at the end of the universe" it is known for hosting a disgusting amount of cp, a disgusting amount of schizophrenic nonsense and obviously even more illegal activity. I'm putting this on here mainly for more content, so just don't go here.
<br><br>
16chan
<br><br>
http://47s7obvdgdpj6fkc.onion/
<br><br>
16chan is very similar to Endchan, full of schizophrenic cyber criminals and pedophiles who just do whatever they want. Or at least did. Because thankfully, as of June 22, 2022 the site 16chan went dead as an error 404.
<br><br>
9chan
<br><br>
http://ninechnjd5aaxfbcsszlbr4inp7qjsficep4hiffh4jbzovpt2ok3cad.onion/
<br><br>
Sort of a joke chan as a mixture between 4chan and 9gag, more similar to 8chan if anything. It's an onion service that is dead along with 16chan so, from here you're pretty much stuck with 8kun or endchan if you want to be apart of a darkweb imageboard.
<br><br>
In short, most of these sites are littered with schizophrenic illegal nonsense which most of the time you don't want to deal with. They're in no order but if I were to put them in one I'd rank from safest to least safe. Before entering any of the these sites I'd just like to say again that warning you that a lot of illegal activity happens on these websites so legally speaking I have to tell you not to go on here.</p>
  </div>
  <div class="overlay"></div>
</div>
<div class="comment-window">
  <h1>Comments</h1>
  <div class="comments-display">
    <?php include 'load_comments.php'; echo loadComments('chatrooms'); ?>
    <form action="save_comment.php" method="POST" onsubmit="return submitComment(event, 'chatrooms')">
      <input type="hidden" name="article_id" value="chatrooms">
      <p>Name: <input type="text" name="username" maxlength="16" required></p>
      <p>Comment: <textarea name="comment" maxlength="256" required></textarea></p>
      <input type="hidden" name="g-recaptcha-response" id="g-recaptcha-response-chatrooms">
      <input type="submit" value="Post">
    </form>
  </div>
</div>
...
<div class="comment-window">
  <h1>Comments</h1>
  <div class="comments-display">
    <?php include 'load_comments.php'; echo loadComments('tails-os'); ?>
    <form action="save_comment.php" method="POST" onsubmit="return submitComment(event, 'tails-os')">
      <input type="hidden" name="article_id" value="tails-os">
      <p>Name: <input type="text" name="username" maxlength="16" required></p>
      <p>Comment: <textarea name="comment" maxlength="256" required></textarea></p>
      <input type="hidden" name="g-recaptcha-response" id="g-recaptcha-response-tails-os">
      <input type="submit" value="Post">
    </form>
  </div>
</div>
...
<div class="window">
  <div class="content">
    <h1 id="buying">How to buy things off of the darkweb</h1>
      <p>Welcome! This is going to be the one of my most viewed articles. So for the ones who are going to be with me through this, thank you for reading. I hope you're very interested in the dark web and security, so from here on if you want to learn more, check out my other articles, other than that enjoy.
<br><br>
...
<br><br>
So now it's in your account, what now? Do you enter the lottery? Do you buy a shitty deal? Do you get scammed? It's completely up to you what you want to do now. However legally speaking, I have to include the fact that "they will catch you" and "It's totally dangerous man" which is exactly why I have more tutorials on how to stay safe! So that the worst thing that happens to you is that the market exit scams and you're left without no Bitcoin. So go check them out and remember to be safe!</p>
  </div>
  <div class="overlay"></div>
</div>
<div class="comment-window">
  <h1>Comments</h1>
  <div class="comments-display">
    <?php include 'load_comments.php'; echo loadComments('buying'); ?>
    <form action="save_comment.php" method="POST" onsubmit="return submitComment(event, 'buying')">
      <input type="hidden" name="article_id" value="buying">
      <p>Name: <input type="text" name="username" maxlength="16" required></p>
      <p>Comment: <textarea name="comment" maxlength="256" required></textarea></p>
      <input type="hidden" name="g-recaptcha-response" id="g-recaptcha-response-buying">
      <input type="submit" value="Post">
    </form>
  </div>
</div>
...
<div class="window">
  <div class="content">
    <h1 id="xmpp">What is XMPP/Jabber and how to use</h1>
      <p>Some people may say that something like Telegram, Signal, WhatsApp, Discord or whatever you think is secure. I promise you one thing and one thing only. They do not have your security and privacy in the best interest. In fact here's a snippet from the Terms of Service and Privacy Policy's of all the Apps.
<br><br>
...
<div class="comment-window">
  <h1>Comments</h1>
  <div class="comments-display">
    <?php include 'load_comments.php'; echo loadComments('xmpp'); ?>
    <form action="save_comment.php" method="POST" onsubmit="return submitComment(event, 'xmpp')">
      <input type="hidden" name="article_id" value="xmpp">
      <p>Name: <input type="text" name="username" maxlength="16" required></p>
      <p>Comment: <textarea name="comment" maxlength="256" required></textarea></p>
      <input type="hidden" name="g-recaptcha-response" id="g-recaptcha-response-xmpp">
      <input type="submit" value="Post">
    </form>
  </div>
</div>
...
<div class="comment-window">
  <h1>Comments</h1>
  <div class="comments-display">
    <?php include 'load_comments.php'; echo loadComments('king'); ?>
    <form action="save_comment.php" method="POST" onsubmit="return submitComment(event, 'king')">
      <input type="hidden" name="article_id" value="king">
      <p>Name: <input type="text" name="username" maxlength="16" required></p>
      <p>Comment: <textarea name="comment" maxlength="256" required></textarea></p>
      <input type="hidden" name="g-recaptcha-response" id="g-recaptcha-response-king">
      <input type="submit" value="Post">
    </form>
  </div>
</div>
...
<div class="window">
  <div class="content">
    <h1 id="vpn-tor">What are the do's and don'ts of using a VPN on the Tor browser?</h1>
...
<br><br>
If you are going to use a VPN, I highly, highly recommend Mullvad VPN, ProtonVPN and then NordVPN, in that order. A good way to remember something like this is: "DON'T, use a VPN with Tor, but if you DO use Mullvad, Proton or Nord…" -Padrino</p>
  </div>
  <div class="overlay"></div>
</div>
<div class="comment-window">
  <h1>Comments</h1>
  <div class="comments-display">
    <?php include 'load_comments.php'; echo loadComments('vpn-tor'); ?>
    <form action="save_comment.php" method="POST" onsubmit="return submitComment(event, 'vpn-tor')">
      <input type="hidden" name="article_id" value="vpn-tor">
      <p>Name: <input type="text" name="username" maxlength="16" required></p>
      <p>Comment: <textarea name="comment" maxlength="256" required></textarea></p>
      <input type="hidden" name="g-recaptcha-response" id="g-recaptcha-response-vpn-tor">
      <input type="submit" value="Post">
    </form>
  </div>
</div>
...
<br><br>
All in all, there's quite a lot of scam on the Tor browser, in fact according to my article mixed with other sources, I can estimate that only 47.05% of the darkweb is legitimate services. Then again, this could factor in only legitimate websites or hell that percentage could only be mirrors. If it's only legitimate websites I'd say around 85.55%, and if it's only mirrors 9.81% is only legitimate. Sadly it's very hard to estimate such a large number, so I'd recommend you just experience it for yourself.</p>
  </div>
  <div class="overlay"></div>
</div>
<div class="comment-window">
  <h1>Comments</h1>
  <div class="comments-display">
    <?php include 'load_comments.php'; echo loadComments('honeypots'); ?>
    <form action="save_comment.php" method="POST" onsubmit="return submitComment(event, 'honeypots')">
      <input type="hidden" name="article_id" value="honeypots">
      <p>Name: <input type="text" name="username" maxlength="16" required></p>
      <p>Comment: <textarea name="comment" maxlength="256" required></textarea></p>
      <input type="hidden" name="g-recaptcha-response" id="g-recaptcha-response-honeypots">
      <input type="submit" value="Post">
    </form>
  </div>
</div>
...
<div class="window">
  <div class="content">
    <h1 id="link-directories">Link Directories for verified tor links</h1>
      <p>Commonplace of Tor, almost the only things associated with Tor is the dark web. What is the dark web? The dark web is the supposed black market of the internet. Homeplace to several drugs, methods, fraudulent items and exit scams. Sadly though, this is only a mere spec on what the reality is. That the Tor browser is home to security. So of course cyber criminals will use markets as their stomping grounds for illicit goods.
<br><br>
...
<br><br>
In short, there's a lot of different onion directories, however these are the most common and most trusted. I didn't include oniontree.org because it is no longer up at this time. However if you ever look up oniontree.org, you'll probably find it. I highly recommend all except thehiddenwiki.</p>
  </div>
  <div class="overlay"></div>
</div>
<div class="comment-window">
  <h1>Comments</h1>
  <div class="comments-display">
    <?php include 'load_comments.php'; echo loadComments('link-directories'); ?>
    <form action="save_comment.php" method="POST" onsubmit="return submitComment(event, 'link-directories')">
      <input type="hidden" name="article_id" value="link-directories">
      <p>Name: <input type="text" name="username" maxlength="16" required></p>
      <p>Comment: <textarea name="comment" maxlength="256" required></textarea></p>
      <input type="hidden" name="g-recaptcha-response" id="g-recaptcha-response-link-directories">
      <input type="submit" value="Post">
    </form>
  </div>
</div>
...
<div id="comments-display">
    ...
    if (isset($_GET['article'])) {
        ...
        require_once 'load_comments.php';
        echo loadComments($article_id);
    }
    ?>
</div>

<script src="https://www.google.com/recaptcha/api.js?render=6LeY0EArAAAAAMxGAJfm7WaGE9BlUw_Zg0PzvEcx"></script>
<script>
function submitComment(event, articleId) {
    event.preventDefault();
    
    // Execute reCAPTCHA
    grecaptcha.execute('6LeY0EArAAAAAMxGAJfm7WaGE9BlUw_Zg0PzvEcx', {action: 'submit_comment'})
    .then(function(token) {
        ...
        .then(data => {
            if (data.success) {
                ...
                form.reset();
                // Reload comments
                const commentsDisplay = form.closest('.comments-display');
                fetch('load_comments.php?article=' + articleId)
...
// Initialize reCAPTCHA for all forms when the page loads
document.addEventListener('DOMContentLoaded', function() {
    const forms = document.querySelectorAll('form[action="save_comment.php"]');
    forms.forEach(form => {
